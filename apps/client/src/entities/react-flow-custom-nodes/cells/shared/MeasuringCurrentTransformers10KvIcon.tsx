...
export const MeasuringCurrentTransformers10KvIcon = memo(
    function MeasuringCurrentTransformers10KvIcon({
        ...
        if (value === key) return { component };
                ...
                {value ===
                    TYPE_OF_MEASURING_CURRENT_TRANSFORMERS_DEVICE_CELL_10KV_OPTIONS.tt2ac && (
                    <Tt2AcIcon color={iconColor} />
                )}
                {value ===
                    TYPE_OF_MEASURING_CURRENT_TRANSFORMERS_DEVICE_CELL_10KV_OPTIONS.tt3ac && (
                    <Tt3AcIcon color={iconColor} />
                )}
                {value ===
                    TYPE_OF_MEASURING_CURRENT_TRANSFORMERS_DEVICE_CELL_10KV_OPTIONS.tt4ac && (
                    <Tt4AcIcon color={iconColor} />
                )}
                {value ===
                    TYPE_OF_MEASURING_CURRENT_TRANSFORMERS_DEVICE_CELL_10KV_OPTIONS.tt2abc && (
                    <Tt2AbcIcon color={iconColor} />
                )}
                {value ===
                    TYPE_OF_MEASURING_CURRENT_TRANSFORMERS_DEVICE_CELL_10KV_OPTIONS.tt3abc && (
                    <Tt3AbcIcon color={iconColor} />
                )}
                {value ===
                    TYPE_OF_MEASURING_CURRENT_TRANSFORMERS_DEVICE_CELL_10KV_OPTIONS.tt4abc && (

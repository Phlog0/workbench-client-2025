...
export function TnIcon({
  ...
  return (
    ...
    >
      <g clipPath="url(#clip0_3_1712)">
        <path d="M300 -4V600" stroke={color} strokeWidth={strokeWidth} />
        <path d="M423 192L452 210" stroke={color} strokeWidth={strokeWidth} />
        <path d="M428 275L453 287" stroke={color} strokeWidth={strokeWidth} />
        <path d="M482 192L452 212" stroke={color} strokeWidth={strokeWidth} />
        <path d="M476 275L451 287" stroke={color} strokeWidth={strokeWidth} />
        <path d="M474 241L454 211" stroke={color} strokeWidth={strokeWidth} />
        <path d="M453 289L453 210" stroke={color} strokeWidth={strokeWidth} />
        <path d="M439 311L453 286" stroke={color} strokeWidth={strokeWidth} />
        <path d="M470 212L454 211" stroke={color} strokeWidth={strokeWidth} />
        <path d="M469 299L453 286" stroke={color} strokeWidth={strokeWidth} />
        <path
        ...
        <path
          ...
          fill="black"
        />
        <path d="M457 593V339" stroke={color} strokeWidth={strokeWidth} />
        <path
          ...
          strokeWidth={strokeWidth}
        />
        <path d="M477 421H437V511H477V421Z" stroke={color} strokeWidth={strokeWidth} />
        <path d="M300 593H460" stroke={color} strokeWidth={strokeWidth} />
      </g>
      <defs>

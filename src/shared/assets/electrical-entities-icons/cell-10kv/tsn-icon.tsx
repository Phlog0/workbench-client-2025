...
export function TsnIcon({
  ...
  return (
    ...
    >
      <g clipPath="url(#clip0_3_1738)">
        <path d="M300 -4V257" stroke={color} strokeWidth={strokeWidth} />
        <path d="M263 404L300 422" stroke={color} strokeWidth={strokeWidth} />
        <path d="M340 410L298 422" stroke={color} strokeWidth={strokeWidth} />
        <path d="M286 463L300 421" stroke={color} strokeWidth={strokeWidth} />
        <path d="M325 441L300 421" stroke={color} strokeWidth={strokeWidth} />
        <path

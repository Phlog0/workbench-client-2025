export function LightningIcon({ color }: { color?: string }) {
  return (
    ...
    >
      ...
      {/* <!-- Статичная фоновая молния --> */}
      <polygon
        id="bgLightning"
        style={{ fill: "#F7CF52", opacity: 0.3 }}
      ...
      <g mask="url(#drawingMask)">
        {/* <!-- Слой 1: Основная анимация рисования --> */}
        <polygon
          id="drawingPath"
          style={{ fill: "#F7CF52", stroke: "#FFA500", strokeWidth: 2 }}
          points="157.055,0 90.798,196.319 164.417,196.319 88.344,400 289.571,159.509 218.405,159.509 311.656,0"
        >
          {/* <!-- Анимация появления штриха --> */}
          <animate
        ...
        {/* <!-- Слой 2: Сияющий эффект --> */}
        <polygon
          id="shiningLightning"
          style={{ fill: "url(#shineGrad)" }}
          points="157.055,0 90.798,196.319 164.417,196.319 88.344,400 289.571,159.509 218.405,159.509 311.656,0"
          opacity="0"
        >
          {/* <!-- Задержка перед началом сияния --> */}
          <animate

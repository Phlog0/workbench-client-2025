...
export const SWITCHING_DEVICE_VV_CELL_10KV_INPUT_RENDER_DATA = [
  {
    ...
    keyTwo: "type",
    inputId: `${SWITCHING_DEVICE_VV_CELL_10KV_KEY_1}TypeCell${VOLTAGE_OPTIONS["10"]}`,
  },
  {
    inputType: "text",
    label: "Наименование",
    keyOne: SWITCHING_DEVICE_VV_CELL_10KV_KEY_1,
    keyTwo: "title",
    inputId: `${SWITCHING_DEVICE_VV_CELL_10KV_KEY_1}TitleCell${VOLTAGE_OPTIONS["10"]}`,
  },
  {
    inputType: "text",
    label: "Производитель",
    keyOne: SWITCHING_DEVICE_VV_CELL_10KV_KEY_1,
    keyTwo: "manufacturer",
    inputId: `${SWITCHING_DEVICE_VV_CELL_10KV_KEY_1}ManufacturerCell${VOLTAGE_OPTIONS["10"]}`,
  },
  {
    inputType: "number",
    ...
    keyOne: SWITCHING_DEVICE_VV_CELL_10KV_KEY_1,
    keyTwo: "ratedCurrent",
    inputId: `${SWITCHING_DEVICE_VV_CELL_10KV_KEY_1}RatedCurrentCell${VOLTAGE_OPTIONS["10"]}`,
  },
  {
    inputType: "number",
    ...
    inputId: `${SWITCHING_DEVICE_VV_CELL_10KV_KEY_1}RatedBreakingCurrentCell${VOLTAGE_OPTIONS["10"]}`,
  },
  {
    inputType: "number",
    ...
    keyOne: SWITCHING_DEVICE_VV_CELL_10KV_KEY_1,
    keyTwo: "ratedVoltage",
    inputId: `${SWITCHING_DEVICE_VV_CELL_10KV_KEY_1}RatedVoltageCell${VOLTAGE_OPTIONS["10"]}`,
  },
] as const;

...
export const OPN_DEVICE_CELL_10KV_INPUT_RENDER_DATA = [
  {
    ...
    keyTwo: "type",
    inputId: `${OPN_DEVICE_CELL_10KV_KEY_1}Type${POSSIBLE_VOLTAGE_DIGITS["10"]}`,
  },
  {
    inputType: "text",
    label: "Наименование",
    keyOne: OPN_DEVICE_CELL_10KV_KEY_1,
    keyTwo: "title",
    inputId: `${OPN_DEVICE_CELL_10KV_KEY_1}Title${POSSIBLE_VOLTAGE_DIGITS["10"]}`,
  },
  {
    inputType: "text",
    label: "Производитель",
    keyOne: OPN_DEVICE_CELL_10KV_KEY_1,
    keyTwo: "manufacturer",
    inputId: `${OPN_DEVICE_CELL_10KV_KEY_1}Manufacturer${POSSIBLE_VOLTAGE_DIGITS["10"]}`,
  },
  {
    inputType: "number",
    ...
    keyOne: OPN_DEVICE_CELL_10KV_KEY_1,
    keyTwo: "throughput",
    inputId: `${OPN_DEVICE_CELL_10KV_KEY_1}Throughput${POSSIBLE_VOLTAGE_DIGITS["10"]}`,
  },
  {
    inputType: "number",
    ...
    inputId: `${OPN_DEVICE_CELL_10KV_KEY_1}RatedDischargeCurrent${POSSIBLE_VOLTAGE_DIGITS["10"]}`,
  },
  {
    inputType: "number",
    ...
    inputId: `${OPN_DEVICE_CELL_10KV_KEY_1}MaximumContinuousPermissibleOperatingVoltage${POSSIBLE_VOLTAGE_DIGITS["10"]}`,
  },
] as const;

...
export const MICROPROCESSOR_DEVICE_CELL_10KV_INPUT_RENDER_DATA = [
  {
    ...
    keyTwo: "type",
    inputId: `${MICROPROCESSOR_DEVICE_CELL_10KV_KEY_1}Type${POSSIBLE_VOLTAGE_DIGITS["10"]}`,
  },
  {
    inputType: "text",
    label: "Наименование",
    keyOne: MICROPROCESSOR_DEVICE_CELL_10KV_KEY_1,
    keyTwo: "title",
    inputId: `${MICROPROCESSOR_DEVICE_CELL_10KV_KEY_1}Title${POSSIBLE_VOLTAGE_DIGITS["10"]}`,
  },
  {
    inputType: "text",
    label: "Производитель",
    keyOne: MICROPROCESSOR_DEVICE_CELL_10KV_KEY_1,
    keyTwo: "manufacturer",
    inputId: `${MICROPROCESSOR_DEVICE_CELL_10KV_KEY_1}Manufacturer${POSSIBLE_VOLTAGE_DIGITS["10"]}`,
  },
] as const;

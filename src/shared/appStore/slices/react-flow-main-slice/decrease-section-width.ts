...
type OriginalAction = ReactFlowNodesPropertiesActions["decreaseSectionWidth"];

type WrappedAction = (
  state: WritableDraft<SharedSlice>,
  ...args: Parameters<OriginalAction>
) => void;
export const decreaseSectionWidth: WrappedAction = (state, { fixatorContainerId, sectionId }) => {

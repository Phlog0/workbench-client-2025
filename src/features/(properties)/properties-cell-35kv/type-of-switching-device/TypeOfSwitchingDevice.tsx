...
export const TypeOfSwitchingDevice = memo(
  ({
    ...
    const options = useMemo(() => {
      return Object.values(TYPE_OF_SWITCHING_DEVICE_CELL_35KV_OPTIONS);
    }, []);
    ...
    return (
      <div className={className}>
        <ProjectPropertySelect
          key1={TYPE_OF_SWITCHING_DEVICE_CELL_35KV_KEY_1}
          label={TYPE_OF_SWITCHING_DEVICE_CELL_35KV_LABEL}
        ...
        {typeOfSwitchingDevice === TYPE_OF_SWITCHING_DEVICE_CELL_35KV_OPTIONS.vv &&
        ...
        {typeOfSwitchingDevice === TYPE_OF_SWITCHING_DEVICE_CELL_35KV_OPTIONS.vn &&
          isVN(switchingDevice) && (
            <SwitchingDeviceVn switchingDevice={switchingDevice} selectedNodeId={selectedNodeId} />
          )}
        {typeOfSwitchingDevice === TYPE_OF_SWITCHING_DEVICE_CELL_35KV_OPTIONS.r &&
          isR(switchingDevice) && (

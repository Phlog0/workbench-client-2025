import {
  ...
  TFixatorContainer,
  TSection10Kv,
} from "@/shared/appStore/react-flow-node-types";
import { TYPE_OF_CELL_OPTIONS_10KV } from "@/shared/constants";
import {
  INITIAL_CELL_10KV_METRICS,
  INITIAL_FIXATOR_CONTAINER_METRICS,
  INITIAL_SECTION_10KV_METRICS,
} from "@/shared/constants/measures/measures";
...
export const INITIAL_CELL_10KV: TOmittedInitialNodes<TCell10Kv> = {
  ...
  draggable: true,
  typeOfCell: TYPE_OF_CELL_OPTIONS_10KV[0],
  // opn: undefined,
  // tt: undefined,
  // tn: undefined,
  // tsn: undefined,
...
export const INITIAL_FIXATOR_CONTAINER: Omit<
  TFixatorContainer,
  "id" | "projectId" | "data" | "parentId"
> = {
